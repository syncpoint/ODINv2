...
export default {
  ...
  'G*F*ACNI--': FILL_HATCH, // NO-FIRE AREA (NFA), IRREGULAR
  'G*F*ACNR--': FILL_HATCH, // NO-FIRE AREA (NFA), RECTANGULAR
  'G*F*AKBI--': FILL_HATCH, // KILL BOX / BLUE, IRREGULAR
  'G*F*AKBR--': FILL_HATCH, // KILL BOX / BLUE, RECTANGULAR
  'G*F*AKPI--': FILL_HATCH, // KILL BOX / PURPLE, IRREGULAR
  'G*F*AKPR--': FILL_HATCH, // KILL BOX / PURPLE, RECTANGULAR
  'G*G*AAW---': FILL_HATCH, // WEAPONS FREE ZONE

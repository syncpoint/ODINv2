...
// TASKS / ISOLATE
styles['MultiPoint:G*T*E-----'] = ({ styles, points, resolution }) => {
  ...
  const xs = TS.projectCoordinates(radius, angle - delta + PI_OVER_2, R.last(arcs[0]))([
    [0.2, -0.2], [0, 0], [0.2, 0.2]
  ])
  ...
  return [
    arcText(styles)(textAnchor, TS.rotation(segment), 'I'),
